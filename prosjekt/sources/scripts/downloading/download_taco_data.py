...
# Crates images folder if standard args are used
if args.images_destination == args_base + "/images" and not os.path.isdir(
    args_base + images_folder
):
    os.mkdir(args_base + images_folder)
...
with open(args.dataset_path, "r") as f:
    ...
    for i in range(nr_images):
        ...
        file_path = os.path.join(args.images_destination, file_name)
